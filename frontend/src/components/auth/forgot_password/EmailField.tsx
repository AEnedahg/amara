...
export default function EmailField({ 
    ...
    register: UseFormRegister<forgotPasswordSchemaType>; 
    errors: FieldErrors<forgotPasswordSchemaType>; 
    watch: UseFormWatch<forgotPasswordSchemaType>; 
}) { 
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className={clsx(
                        ...
                        errors.email
                            ? "outline-red-500 bg-red-50 text-red-500 focus:outline-red-500 border-2 border-red-500"
                            : email
